USE [master]
GO
/****** Object:  Database [TC_Practice]    Script Date: 12/8/2025 4:27:58 PM ******/
CREATE DATABASE [TC_Practice]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'TC_Practice', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\TC_Practice.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'TC_Practice_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\TC_Practice_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
 WITH CATALOG_COLLATION = DATABASE_DEFAULT, LEDGER = OFF
GO
ALTER DATABASE [TC_Practice] SET COMPATIBILITY_LEVEL = 160
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [TC_Practice].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [TC_Practice] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [TC_Practice] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [TC_Practice] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [TC_Practice] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [TC_Practice] SET ARITHABORT OFF 
GO
ALTER DATABASE [TC_Practice] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [TC_Practice] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [TC_Practice] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [TC_Practice] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [TC_Practice] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [TC_Practice] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [TC_Practice] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [TC_Practice] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [TC_Practice] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [TC_Practice] SET  DISABLE_BROKER 
GO
ALTER DATABASE [TC_Practice] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [TC_Practice] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [TC_Practice] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [TC_Practice] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [TC_Practice] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [TC_Practice] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [TC_Practice] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [TC_Practice] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [TC_Practice] SET  MULTI_USER 
GO
ALTER DATABASE [TC_Practice] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [TC_Practice] SET DB_CHAINING OFF 
GO
ALTER DATABASE [TC_Practice] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [TC_Practice] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [TC_Practice] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [TC_Practice] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
EXEC sys.sp_db_vardecimal_storage_format N'TC_Practice', N'ON'
GO
ALTER DATABASE [TC_Practice] SET QUERY_STORE = ON
GO
ALTER DATABASE [TC_Practice] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
USE [TC_Practice]
GO
/****** Object:  Schema [dim]    Script Date: 12/8/2025 4:27:59 PM ******/
CREATE SCHEMA [dim]
GO
/****** Object:  Schema [fact]    Script Date: 12/8/2025 4:27:59 PM ******/
CREATE SCHEMA [fact]
GO
/****** Object:  Schema [Sales]    Script Date: 12/8/2025 4:27:59 PM ******/
CREATE SCHEMA [Sales]
GO
/****** Object:  Schema [src]    Script Date: 12/8/2025 4:27:59 PM ******/
CREATE SCHEMA [src]
GO
/****** Object:  Schema [stg]    Script Date: 12/8/2025 4:27:59 PM ******/
CREATE SCHEMA [stg]
GO
/****** Object:  Schema [vw]    Script Date: 12/8/2025 4:27:59 PM ******/
CREATE SCHEMA [vw]
GO
/****** Object:  Table [dim].[Calendar]    Script Date: 12/8/2025 4:27:59 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dim].[Stores]    Script Date: 12/8/2025 4:27:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [fact].[Sales]    Script Date: 12/8/2025 4:27:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [fact].[Sales](
	[pkSales] [bigint] NOT NULL,
	[transaction_date] [date] NULL,
	[store_id] [int] NULL,
	[TotalSale] [decimal](18, 3) NULL,
PRIMARY KEY CLUSTERED 
(
	[pkSales] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
...
GO
/****** Object:  Table [src].[Regions]    Script Date: 12/8/2025 4:27:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [src].[Sales23]    Script Date: 12/8/2025 4:27:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [src].[Sales24]    Script Date: 12/8/2025 4:27:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [src].[Stores]    Script Date: 12/8/2025 4:27:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
USE [master]
GO
ALTER DATABASE [TC_Practice] SET  READ_WRITE 
GO
